...
const LeaveRequestPage = () => {
  ...
  return (
    <>
      ...
      <div className='bg-gradient-to-r from-[#0D091E] to-[#54239B] rounded-2xl mx-2 sm:mx-4 md:mx-6 lg:mx-8 mt-4 sm:mt-6 md:mt-8 sticky top-16 sm:top-20 z-40 shadow-sm p-4 sm:p-6 md:p-8 lg:p-10'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-10 lg:gap-16 m-2 sm:m-4 md:m-6 lg:m-8 mb-3'>
      ...
      <div className='w-full min-w-0 px-4 sm:px-6 md:px-8 lg:px-15'>
        <div className='pt-6 sm:pt-8 md:pt-10 pb-4'>
          <ApplyLeaveCard />
        </div>
        <div className='flex mb-12 sm:mb-16 md:mb-18'>
          <LeaveDetailsCard />
        </div>
      </div>
    </>
