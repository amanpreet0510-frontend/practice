...
const TaskPage = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-w-0 overflow-x-hidden  -mt-2 sm:mt-0">
      <div className="bg-gradient-to-r from-[#0D091E] to-[#54239B] sticky  z-[99] border-b border-zinc-500 shadow-sm p-5  rounded-xl mb-8">
        ...
        <div className="hidden lg:flex  p font-bold  top-0 z-50 rounded-2xl  shadow-zinc-500 shadow-[5px_0px_15px_rgba(0,0,0,0.3)] p-1 md:p-10 gap-1 xl:gap-5 m-2 mt-10  ">
        ...
        <div className="lg:grid lg:grid-cols-2  ">
          ...
          <Card className="w-auto  lg:w-full right-0 max-h-fit text-zinc-700 mt-5   font-bold  top-0 z-50 rounded-2xl border border-zinc-500  p-1 md:p-10  gap-5 ">
