  ...
  return (
    <>
      <aside className="border-r border-zinc-600 bg-[#0F0E23] w-100 p-5 sticky top-0 max-h-screen">
        ...
        <button onClick={handleLogout} className="text-zinc-400 text-xl font-bold mt-25 p-5 w-full py-3 rounded-xl border-l border-r border-2 border-zinc-700 shadow-lg shadow-zinc-700 bg-transparent hover:bg-zinc-100 transition">LogOut</button>
      </aside>
    </>
  );
};
