...
export const AttenadanceCard = () => {
  ...
  return (
    <>
      <div className="m-5 pt-0  lg:p-10 md:pt-0 rounded-2xl ">
        <Card className="p-5 md:p-5 md:mt-10 md:mb-5 rounded-2xl bg-zinc-100 border-zinc-300 text-zinc-600">
          <div className="justify-between">
            <div>
              <CardHeader className="text-lg md:text-2xl font-semibold">
                Today's Status
              </CardHeader>
              <CardContent>
                <p className="text-sm md:text-2xl font-bold">{formattedDate}</p>
              </CardContent>
              {currentSession ? (
                <div className="p-6">
            ...
            <div>
              {currentSession ? (
                <Button
                  ...
                  disabled={loading}
                  className="bg-zinc-700 text-zinc-300 text-xl hover:bg-red-600 m-5 md:m-10 w-30 md:h-15 md:w-100"
                >
                ...
                <Button
                  onClick={handleLogin}
                  disabled={loading}
                  className="text-zinc-200 font-bold text-sm md:text-xl bg-gradient-to-r from-[#0D091E] to-[#54239B] hover:bg-[#4E2190] m-1 ms-5 md:m-10 w-30 md:h-15 md:w-100"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-10">
          ...
          <Card className="mt-5 md:mt-8 bg-zinc-200 text-zinc-800 text-lg font-manrope  border-zinc-300  h-50">
            <div>
              <div className="flex justify-between gap-10 p-5 lg:p-10 m-5">
        ...
        <div className="mt-8 md:mt-13 mb-15">
          <Card className='bg-zinc-200 border-zinc-300  h-150' >
            <h1 className="text-2xl font-semibold ps-10 pt-5 text-zinc-600">Attendance History</h1>
            <div className="">
              <div>
            <div className="ps-0 ms-5 me-5 border-zinc-300 border-2">
              <div className="flex ms-5 md:ms-0 gap-4 lg:gap-0  justify-around text-[10px] lg:text-xl text-zinc-500 font-bold">
                <h2>Date</h2>
                <h2>Check In</h2>
                <h2>Check Out</h2>
                <h2>Duration</h2>
            ...
            {sessions.length > 0 ? (
              <div className="p-5">
                {sessions.map((session) => (
                  <div
                    key={session.id}
                    className="flex justify-between  text-sm p-3  hover:bg-gray-50 "
                  >
